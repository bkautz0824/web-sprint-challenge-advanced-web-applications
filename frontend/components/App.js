...
export default function App() {
  ...
  const logout = () => {
    ...
    // return window.localStorage.getItem('token') ? window.localStorage.removeItem('token') 
    // && setMessage('Goodbye!') 
    // && navigate('/')
    // : 
    // navigate('/')
      ...
      <div id="wrapper" style={{ opacity: spinnerOn ? "0.25" : "1" }}> {/* <-- do not change this line */}
        ...
        <Routes>
          ...
          <Route path="articles" element={
            <AuthRoute>
              <ArticleForm updater={updater} article={articles.find(art => art.article_id === currentArticleId)} />
